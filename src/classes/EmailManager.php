 ...
 * Arquivo: src/classes/EmailManager.php
 */
...
class EmailManager {
    ...
    public function __construct() {
        ...
        $this->config = [
            'enabled' => false,  // Desabilitar emails por padrão (ativar conforme necessário)
            'from_email' => 'noreply@app-agenda.com',
            'from_name' => 'Ink Agenda Pro',
            'admin_email' => 'admin@app-agenda.com'
        ];
    }
